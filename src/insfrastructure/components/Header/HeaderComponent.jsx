...
import buyCarIcon  from "../../../assets/añadir-al-carrito.png";
...
export function HeaderComponent() {
  ...
  return (
    <header className="w-full flex flex-wrap justify-between items-center p-4 text-white">
      ...
      <nav className="w-full sm:w-auto mt-4 sm:mt-0">
        <ul className="flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-8 font-poppins">
          <li>
            <NavLink to="/" className="text-lg hover:text-gray-400" href="#">
              Inicio
            </NavLink>
          </li>
          <li>
          ...
          <li>
            <a className="text-lg hover:text-gray-400" href="#">
              Proyectos
            </a>
          </li>
          <li>
            <a className="text-lg hover:text-gray-400" href="#contactUs">
              Contactar
            </a>
          </li>
        </ul>
      ...
      <div className="flex justify-center items-center gap-10">
        <Link to={"/CheckOut"}><img src={buyCarIcon}/></Link>
        <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white rounded-full overflow-hidden flex-shrink-0">
          <li><img src="" alt="Perfil" className="w-full h-full object-cover" /></li>
        </div>
      </div>
    </header>
  );
