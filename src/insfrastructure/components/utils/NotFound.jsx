export function NotFound() {
  return (
    <div class="no-file-found h-svh flex flex-col items-center justify-center py-8 px-4 text-center bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md">
      <svg
